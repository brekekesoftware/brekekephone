...
function Adapter(options) {
    ...
    Adapter.fixRTCOfferOptions = function (options) {
        ...
        //for react-native-webrtc //!comment
        if (options.mandatory && options.mandatory.hasOwnProperty('_____SKIP_Adapter_fixRTCOfferOptions_____')) {
        }
        else if (!oldSpecRTCOfferOptions) { // New spec.
