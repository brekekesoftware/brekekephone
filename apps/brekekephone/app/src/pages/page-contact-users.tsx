...
export const PageContactUsers = observer(
  class PageContactUsers extends Component {
    ...
    getDescription = (isUserSelectionMode: boolean) => {
      ...
      if (!isUserSelectionMode) {
        ...
        const { totalContact = 0, totalOnlineContact = 0 } =
          ctx.user.filterUser(searchTxt, isShowOfflineUser)
    ...
    renderAllUserMode = () => {
      ...
      const displayUsers =
        !this.displayOfflineUsers.enabled && ca.ucEnabled
          ? onlineUsers
          : allUsers
