...
import {StyleSheet, View, TouchableOpacity as Button, Text} from 'react-native'
    ...
    return <View style={st.main}>
        ...
        <Button style={st.opt}
            ...
            <Text style={st.optTitle}>
                End Call and Complete Transfer
            </Text>
        </Button>
        <Button style={st.opt}
                onPress={p.stop}>
...
const CallTransferAttend = (p) => p.call
? <Main {...p} />
: <NoCall back={p.back} />
