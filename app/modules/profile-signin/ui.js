...
import {StyleSheet, View, TouchableOpacity as Button, Text, TextInput} from 'react-native'
  ...
  <View style={st.form}>
    <View style={st.profile}>
      <Text style={st.profileTitle}>
        {p.tenant ? p.tenant + '/' : ''}{p.username}
      </Text>
      <Text style={st.profileCaption}>
        {p.hostname + ':' + p.port}
      </Text>
    </View>
    <TextInput style={st.passwordInput}
      autoFocus
      secureTextEntry
...
const Main = (p) => (
  <View style={st.main}>
    <View style={st.navbar}>
      ...
      <Button style={st.navbarOptRight}
        onPress={p.signin}>
        <Text style={st.navbarOptText}>
          Sign in
        </Text>
