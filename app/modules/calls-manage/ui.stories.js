...
storiesOf(UI.name, module)
  .add('no selecting call', () => <UI
    runningIds={['incoming', 'outgoing', 'answered', 'recording', 'holding', 'video']}
    runningById={{incoming, outgoing, answered, recording, holding, video}}
    parkingIds={[12001, 12002, 12003]}
    {...opts}
  />)
  .add('selecting incoming call', () => <UI
    runningIds={['incoming', 'outgoing', 'answered', 'recording', 'holding', 'video']}
    runningById={{incoming, outgoing, answered, recording, holding, video}}
    selectedId='incoming'
    parkingIds={[12001, 12002, 12003]}
    {...opts}
  />)
  .add('selecting outgoing call', () => <UI
    runningIds={['incoming', 'outgoing', 'answered', 'recording', 'holding', 'video']}
    runningById={{incoming, outgoing, answered, recording, holding, video}}
    selectedId='outgoing'
    parkingIds={[12001, 12002, 12003]}
    {...opts}
  />)
  .add('selecting answered call', () => <UI
    runningIds={['incoming', 'outgoing', 'answered', 'recording', 'holding', 'video']}
    runningById={{incoming, outgoing, answered, recording, holding, video}}
    selectedId='answered'
    parkingIds={[12001, 12002, 12003]}
  ...
  .add('selecting holding call', () => <UI
    ...
    {...opts}
  />)
  .add('selecting recording call', () => <UI
    runningIds={['incoming', 'outgoing', 'answered', 'recording', 'holding', 'video']}
    runningById={{incoming, outgoing, answered, recording, holding, video}}
