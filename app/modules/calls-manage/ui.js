...
import {StyleSheet, View, ScrollView, Text, TouchableOpacity as Button} from 'react-native'
    ...
    <View style={st.controlOpts}>
        {!p.holding && (
            <View style={st.actionIcon}>
              ...
              <Text style={st.tipText} onPress={p.hangup}>Hangup</Text>
            </View>
        )}
      {p.incoming && !p.answered && (
          <View style={st.actionIcon}>
            ...
            <Text style={st.tipText} onPress={p.answer}>Answer</Text>
          </View>
      )}
      {p.answered && p.holding && (
          <View style={st.actionIcon}>
        <Button style={st.controlOpt}
          ...
          <Text style={st.optIconAction}>
            icon_play
              ...
              <Text style={st.tipText} onPress={p.unhold}>Unhold</Text>
          </View>
      )}
      {p.answered && !p.holding && (
          <View style={st.actionIcon}>
        <Button style={st.controlOpt}
          ...
          <Text style={st.optIconAction}>
            icon_phone_forwarded
              ...
              <Text style={st.tipText} onPress={p.transfer}>Transfer</Text>
          </View>
      )}
      {p.answered && !p.holding && (
          <View style={st.actionIcon}>
            <Button style={st.controlOpt}
              ...
              <Text style={st.tipText} onPress={p.park}>Park</Text>
          </View>
      )}
        ...
        <Button style={st.controlOpt}
          ...
          <Text style={st.optIconDanger}>
            icon_video_off
              ...
              <Text style={st.tipText} onPress={p.disableVideo}>Video</Text>
          </View>
      )}
      {p.answered && !p.holding && !p.localVideoEnabled && (
          <View style={st.actionIcon}>
            <Button style={st.controlOpt}
              ...
              <Text style={st.tipText} onPress={p.enableVideo}>Video</Text>
          </View>
      )}
        ...
        <Button style={st.controlOpt}
          ...
          <Text style={st.optIconAction}>
            icon_disc
              ...
              <Text style={st.tipText} onPress={p.startRecording}>Recording</Text>
          </View>
      )}
      {p.answered && !p.holding && p.recording && (
          <View style={st.actionIcon}>
        <Button style={st.controlOpt}
          ...
          <Text style={st.optIconDanger}>
            icon_stop_circle
              ...
              <Text style={st.tipText} onPress={p.stopRecording}>Recording</Text>
          </View>
      )}
      {p.answered && !p.holding && (
          <View style={st.actionIcon}>
        <Button style={st.controlOpt}
          ...
          <Text style={st.optIconAction}>
            icon_keypad
              ...
              <Text style={st.tipText} onPress={p.dtmf}>Keypad</Text>
          </View>
      )}
      {p.answered && !p.holding && (
          <View style={st.actionIcon}>
        <Button style={st.controlOpt}
          ...
          <Text style={st.optIconAction}>
            icon_pause
              ...
              <Text style={st.tipText} onPress={p.hold}>Hold</Text>
          </View>
      )}
    </View>
  </View>
...
const RunningItem = (p) => (
  <Button style={st.call} onPress={p.select}
    disabled={p.selected}>
    {p.selected && (
      <View style={st.callSelected} />
    )}
    {!p.answered && p.incoming && (
