...
class View extends Component {
  ...
  editContact = (id) => {
    this.setState(immutable.on(this.state)(
  ...
  saveContact = (id) => {
    ...
    pbx.setContact(this.state.contactById[id])
  ...
  setContactFirstName = (id, val) => {
    this.setState(immutable.on(this.state)(
      ...
      immutable.vset(`contactById.${id}.name`,
  ...
  setContactJob = (id, val) => {
    this.setState(immutable.on(this.state)(
      immutable.vset(`contactById.${id}.job`, val)
    ))
  }
  ...
  setContactEmail = (id, val) => {
    this.setState(immutable.on(this.state)(
      immutable.vset(`contactById.${id}.email`, val)
    ))
  }
  ...
  loadContacts = debounce(() => {
    ...
    pbx.getContacts(book, shared, opts)
