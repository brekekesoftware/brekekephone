...
import {StyleSheet, View, ScrollView, TouchableOpacity as Button, Text, ActivityIndicator} from 'react-native'
...
const Navbar = (p) => (
  <View style={st.navbar}>
    ...
    <Button style={st.navbarRightAction}
      onPress={p.create}>
      <Text style={st.navbarActionText}>
        Create
      </Text>
    </Button>
  </View>
