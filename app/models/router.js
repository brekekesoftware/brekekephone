...
import {parse as queryStringToObject, stringify as objectToQueryString} from 'query-string'
...
export default {
  ...
  action: {
    ...
    goToContactsBrowse: (query) => push(`/auth/contacts/browse?${objectToQueryString(query)}`),
    goToContactsCreate: (query) => push(`/auth/contacts/create?${objectToQueryString(query)}`)
  }
}
