...
const persistConfig = {key: 'brekeke-phone', storage, whitelist: persistedReducers, version: '3.0.0'}
const storeReducer = persistReducer(persistConfig, reduce)

const routerHistory = Platform.OS === 'web' ? createHashHistory() : createMemoryHistory()
...
const Routing = () => (
    <View style={StyleSheet.absoluteFill}>
        ...
        <Route exact path='/auth/call/:call/transfer/dial' component={CallTransferDial} />
        <Route exact path='/auth/call/:call/transfer/attend' component={CallTransferAttend} />
        ...
        <Route exact path='/auth/chats/buddy/:buddy/recent' component={BuddyChatsRecent} />
        <Route exact path='/auth/chats/group/:group/recent' component={GroupChatsRecent} />
        <Route exact path='/auth/chat-groups/create' component={ChatGroupsCreate} />
        <Route exact path='/auth/chat-group/:group/invite' component={ChatGroupInvite} />
