  ...
  protected Void doInBackground(Void... params) {
    try {
      ...
      NotificationCompat.Builder notification =
          new NotificationCompat.Builder(mContext, bundle.getString("channel"))
      ...
      if (bundle.containsKey("fire_date")) {
        ...
        Intent i = new Intent("com.brekeke.fcm.ReceiveLocalNotification");
        i.putExtras(bundle);
      ...
      if (!mIsForeground || bundle.getBoolean("show_in_foreground")) {
        ...
        if (bundle.containsKey("android_actions")) {
          ...
          for (int a = 0; a < actions.size(); a++) {
            ...
            actionIntent.setAction("com.brekeke.fcm." + actionId + "_ACTION");
            actionIntent.putExtras(bundle);
            actionIntent.putExtra("_actionIdentifier", actionId);
            actionIntent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
            PendingIntent pendingActionIntent =
                PendingIntent.getActivity(
                    mContext, notificationID, actionIntent, PendingIntent.FLAG_UPDATE_CURRENT);
