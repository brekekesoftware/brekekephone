...
import com.tlschannel.impl.BufferHolder;
import com.tlschannel.impl.ByteBufferSet;
import com.tlschannel.impl.TlsChannelImpl;
import com.tlschannel.impl.TlsChannelImpl.EofException;
import com.tlschannel.impl.TlsExplorer;
  ...
  private static class SniSslContextStrategy implements SslContextStrategy {
    ...
    public SSLContext getSslContext(SniReader sniReader) throws IOException, EofException {
      ...
      try {
        ...
        logger.log(
            Level.FINEST,
            "client code threw exception during evaluation of server name indication",
            e);
