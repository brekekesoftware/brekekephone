...
import { debounce, isEmpty } from 'rntwsc/libs/lodash'
...
import type { CancelRecentPn } from '#/stores/cancel-recent-pn'
...
import { shouldUseResourceLine } from '#/utils/resource-line'
...
export class CallStore {
  ...
  onCallKeepAnswerCall = (uuid: string) => {
    ...
    const autoAnswered = this.getCallKeep(uuid, {
      includingAnswered: true,
    })
