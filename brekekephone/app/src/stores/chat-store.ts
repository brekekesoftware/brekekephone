...
import { rnVibrate } from '#/utils/rn-vibrate'
import { saveBlobFile } from '#/utils/save-blob'
import { webPlayDing } from '#/utils/web-play-ding'
import { webShowNotification } from '#/utils/web-show-notification'
...
export class ChatStore {
  ...
  suppressNextLocalNotification = (threadId?: string, body?: string) => {
    ...
    this.suppressedLocalNotifications.push({
      threadId,
      body: b,
      at: now,
    })
