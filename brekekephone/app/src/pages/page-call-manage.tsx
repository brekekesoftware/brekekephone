...
export const PageCallManage = observer(
  ({ call: c, embedded = false }: { call: Call; embedded?: boolean }) => {
    ...
    const ctrlBtnContainerClassName = isLandscape ? 'mx-0 mb-1.25' : 'mb-2.5'
        ...
        >
          {n > 0 && (
            <FieldButton
              ...
              onCreateBtnPress={() =>
                navOnMain(ctx.nav.goToPageCallBackgrounds)
              }
          ...
          >
            {!isBtnHidden('transfer') && (
              <ButtonIcon
                ...
                noborder
                onPress={() =>
                  navOnMain(ctx.nav.goToPageCallTransferChooseUser)
                }
                path={mdiCallSplit}
                size={ctrlBtnSize}
              />
        ...
        >
          {c.holding && !c.rqLoadings['hold'] ? (
            <View
              className={[
                'mb-2.5 h-16.25',
                isLandscape && 'items-center justify-center self-stretch',
              ]}
            >
    ...
    return (
      ...
      >
        <Layout
          ...
          iconRightFuncs={[() => navOnMain(navChatDetail)]}
          noScroll
          onBack={() => navOnMain(backAction)}
