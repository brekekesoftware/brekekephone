import type { ThemeVariables } from '@rntwsc/rn/core/twrnc-config'
...
export const variables: ThemeVariables = {
  ...
  '--foreground': '#000000',
  '--foreground-subtle': '#101010',
  '--foreground-muted': '#202020',
  '--foreground-disabled': '#505050',
